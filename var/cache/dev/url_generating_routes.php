...
return [
    ...
    'example_2' => [[], ['_controller' => 'App\\Controller\\ExampleController::new'], [], [['text', '/service/example/2']], [], [], []],
    'service_injected' => [[], ['_controller' => 'App\\Controller\\InjectedController::new'], [], [['text', '/service/injectedexample']], [], [], []],
    ...
    'records_show' => [['id'], ['_controller' => 'App\\Controller\\StudentRegistrationController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/exampleform']], [], [], []],
    ...
    'message' => [[], ['_controller' => 'App\\Controller\\MessageController::greetings'], [], [['text', '/']], [], [], []],
];
